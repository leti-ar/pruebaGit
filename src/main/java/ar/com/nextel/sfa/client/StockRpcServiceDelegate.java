...
public class StockRpcServiceDelegate {
	...
	public void validarStock(Long idLPrecio, Long idItem, Long idVendedor, AsyncCallback<String> callback){
		WaitWindow.show();
		stockRpcServiceAsync.validarStock(idLPrecio, idItem, idVendedor, callback);
	}
}
