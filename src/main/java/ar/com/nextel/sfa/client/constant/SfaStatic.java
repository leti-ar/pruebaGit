...
public interface SfaStatic extends com.google.gwt.i18n.client.Constants {
  ...
  /**
   * Translated "Categor�a".
   * 
   * @return translated "Categor�a"
   */
  @DefaultStringValue("Categor�a")
  @Key("categoria")
  String categoria();
   ...
   * Translated "Desv�os:".
   * 
   * @return translated "Desv�os:"
   */
  @DefaultStringValue("Desv�os:")
  @Key("desvios")
  String desvios();
   ...
   * Translated "Divisi�n".
   * 
   * @return translated "Divisi�n"
   */
  @DefaultStringValue("Divisi�n")
  @Key("division")
  String division();
