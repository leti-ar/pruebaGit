 ...
 * analista de creditos que est�n en la misma sucursal.
 * @author fernaluc
 *
 */
...
public class BuscarSSAnalistaCreditosUI extends BuscarSSGenericoUI {
	...
	@Override
	public boolean load() {
		// Si es cliente de Nexus no aparecer� ningun filtro para la busqueda, se busca directamente todas las SS 
