...
//se recupero modificacion hecha en branch sfa_planes_no_vigentes_br
...
//fin se recupero modificacion hecha en branch sfa_planes_no_vigentes_br
...
//					editarSSUIData.modificarDescuentoTotal(descuentoSeleccionados);
	...
	private void drawDetalleSSRow(LineaSolicitudServicioDto linea, int newRow) {
		...
		detalleSS.setHTML(newRow, controller.isEditable()?15-i:++i, linea.getDdi() ? IconFactory.tildeVerde().toString() : Sfa.constant().whiteSpace());
