...
public class DatosSSUI extends Composite {
	...
	public DatosSSUI(CrearSSUIData crearSSUIData) {
	...
	private Widget firstRow() {
		...
		layout.setHTML(0, 2, Sfa.constant().nss());
		layout.setWidget(0, 3, crearSSUIData.getNss());
		layout.setHTML(0, 4, Sfa.constant().nss());
		layout.setWidget(0, 5, crearSSUIData.getNss());
		return layout;
	}
