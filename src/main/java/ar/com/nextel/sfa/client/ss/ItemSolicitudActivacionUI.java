...
public class ItemSolicitudActivacionUI extends Composite {
	...
	public ItemSolicitudActivacionUI(ItemSolicitudUIData itemSolicitudUIData) {
	...
	private void initItemSolicitudActivacionUI() {
		...
		segundaTabla.setWidget(0, 1, itemSolicitudUIData.getPrecioListaItem());
		...
		terceraTabla.setWidget(1, 0, new InlineLabel(Sfa.constant().planReq()));
		...
		terceraTabla.setWidget(2, 1, itemSolicitudUIData.getPrecioListaPlan());
		...
		cuartaTabla.setWidget(0, 1, itemSolicitudUIData.getModalidadCobro());
