...
//		MGR - #3462 - Inicio NO necesario
		//LF - #3141 - Se agregan los SA para ActivaciÃ³n - Activacion On-Line
//		if(linea.getTipoSolicitud().isActivacion() || linea.getTipoSolicitud().isActivacionOnline()) {
//			MGR - #3331
...
//							Si el pass se da por Scoring, sigue su curso normal
							if(cierrePorVeraz && !"T".equals(isVerazDisponible.get(0))){
								...
								//la SS quedando pendiente de aprobaciÃ³n en vantive y se envia un mail informando la situacion
...
//	}
	 ...
	 * @param set
	 * @return Un mensaje que indica las lÃ­neas que no pasaron la validacion.
	 * @throws RpcExceptionMessages
	 */
//	MGR - Parche de emergencia
