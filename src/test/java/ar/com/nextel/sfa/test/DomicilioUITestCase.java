...
public class DomicilioUITestCase extends SfaSeleniumTest {
	...
	public void testDomicilioUITestCase() throws Exception {
		...
		waitForElement(DebugConstants.GWT_BUSQUEDA_CUENTAS_COMBO_PREDEFINIDAS);
		...
		waitForElement(DebugConstants.GWT_BUSQUEDA_CUENTAS_TABLE_RESULT);

		selenium.click("//table[@id='" + DebugConstants.GWT_BUSQUEDA_CUENTAS_TABLE_RESULT + "']/tbody/tr[5]/td[1]/div");

		waitForElement("//input[@name='Teléfono/Fax Celular Cod área']");
		...
		waitForElement("//table[@id='"+ DebugConstants.GWT_TABLE_DOMICILIO_NORMALIZADO + "']/tbody/tr[2]/td");
